...
4) This new data set is molten and casted in such way that the final dataframe shows a data set order in the following way:

Ordered by Subject / Ordered by activity / mean of all "std" and "mean" variables of the orginal data set.

This is exported as a text file.

#Exported data set (txt file) variables:

180 observations and 81 variables

subjects                       : int  1 1 1 1 1 1 2 2 2 2 ...

activities                     : Factor w/ 6 levels "WALKING","WALKING_UPSTAIRS",..: 1 2 3 4 5 6 1 2 3 4 ...
